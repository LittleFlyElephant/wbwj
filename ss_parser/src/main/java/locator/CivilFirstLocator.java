...
public class CivilFirstLocator{
	...
	public static CivilFirstLocator getInstance(){
		return locator;
	}
	...
	{
		patternList.add(new Pattern("查明事实段","//CMSSD/@value","经审理查明"));
		//patternList.add(new Pattern("原告诉称段","//YGSCD/@value","","//CMSSD/@value","经审理，本院查明的事实与原告主张的事实一致。"));
		patternList.add(new Pattern("查明事实段2","//CMSSD/@value",""));
